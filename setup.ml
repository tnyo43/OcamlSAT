...
(* OASIS_START *)
(* DO NOT EDIT (digest: ba8279f95af52dbd8e88b5ba2a124661) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/cdcl";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "dpll"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "dpll"; InternalLibrary "cdcl"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "dpll";
                           InternalLibrary "cdcl";
                           InternalLibrary "sudoku"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
     ...
     oasis_digest = Some "DAZ\182\164E9\228\162\005x\030g\250L\213";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
